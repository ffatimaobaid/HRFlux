...
class ChatGroqWithRetry(ChatGroq):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.max_retries = 5
        # Store original parameters for creating fresh instances
    ...
    def invoke(self, input: Any, config: Optional[dict] = None, **kwargs) -> Any:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                error_str = str(e)
                print(f"ChatGroq Invoke Attempt {attempt + 1}/{self.max_retries}: {error_str}")
...
def create_chat_groq_with_retry(model_name: str = "llama-3.3-70b-versatile", 
                               ...
                               max_tokens: int = 400) -> ChatGroqWithRetry:
